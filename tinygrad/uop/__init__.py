...
class Ops(FastEnum):
  ...
  RESHAPE = auto(); PERMUTE = auto(); EXPAND = auto(); PAD = auto(); SHRINK = auto(); FLIP = auto(); AS_STRIDED = auto()
...
class GroupOp:
  ...
  Movement = {Ops.RESHAPE, Ops.EXPAND, Ops.PERMUTE, Ops.PAD, Ops.SHRINK, Ops.FLIP, Ops.AS_STRIDED, Ops.MULTI}
